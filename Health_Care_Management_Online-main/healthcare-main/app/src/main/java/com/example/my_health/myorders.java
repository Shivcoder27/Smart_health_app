...
public class myorders extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // Toast.makeText(getApplicationContext(),""+data, Toast.LENGTH_LONG).show();
        ArrayAdapter adapt = new ArrayAdapter(this, com.google.android.material.R.layout.support_simple_spinner_dropdown_item,data);
        ...
        checkout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                OederConfirme.usernameprdct = username;
                OederConfirme.finalTotalamount = String.valueOf(finalTotalamount);


                startActivity(new Intent(myorders.this,OederConfirme.class));
            }
        });
